...
import { AttributeLabelName, AttributeWrapper, PropertyWrapper, UserInfoAttribute } from './ProfileInfoProperty'
        ...
        <UserPasswordContainer>
            ...
            <DetailsInfoContainer>
                <PasswordForm>
                    <PropertyWrapper>
                        <AttributeWrapper>
                            <PasswordAttributeLabelName htmlFor="Old Password">Old Password:</PasswordAttributeLabelName>
                            <UserInfoAttribute type="text" value="" disabled={disabled} />
                        </AttributeWrapper>
                        <AttributeWrapper>
                            <PasswordAttributeLabelName htmlFor="New Password">New Password:</PasswordAttributeLabelName>
                            <UserInfoAttribute type="text" value="" disabled={disabled} />
                        </AttributeWrapper>
                    </PropertyWrapper>
                </PasswordForm>
