...
const Footer = () => (
    <HomeFooter>
        ...
        <FooterContent>
            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Voluptatum ipsa aspernatur minus veritatis enim quos fugiat pariatur, amet adipisci. Voluptates suscipit at sapiente minus sunt in officiis animi error iure?</p>
        </FooterContent>
